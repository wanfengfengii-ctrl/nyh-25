import "clsx";
import { a5 as sanitize_props, a6 as rest_props, a7 as fallback, a8 as attributes, a9 as ensure_array_like, aa as element, a4 as slot, ab as bind_props, ac as spread_props, ad as attr_class, ae as clsx, e as escape_html, af as attr, ag as store_get, ah as unsubscribe_stores, ai as attr_style, aj as stringify } from "../../chunks/index.js";
...
function _page($$renderer) {
  ...
  $$renderer.push(`<!----></div> <div><h1 class="font-display text-xl font-bold text-amber-500 tracking-wider">日晷模拟器</h1> <p class="text-xs text-slate-500">Sundial Simulator</p></div></div> <div class="text-sm text-slate-400 hidden sm:block">多方案对比 · 全年太阳轨迹分析</div></div></header> <main class="max-w-[1800px] mx-auto px-4 sm:px-6 py-6"><div class="grid grid-cols-12 gap-6 h-[calc(100vh-100px)]"><div class="col-span-12 lg:col-span-3 h-full overflow-hidden">`);
  ...
  $$renderer.push(`<!----></div> <div class="h-[280px] flex-shrink-0">`);
  CompareSummary($$renderer);
  $$renderer.push(`<!----></div></div> <div class="col-span-12 lg:col-span-3 flex flex-col gap-6 h-full overflow-hidden"><div class="h-[380px] flex-shrink-0 overflow-hidden">`);
  ShadowTrack($$renderer);
  $$renderer.push(`<!----></div> <div class="flex-1 min-h-0 overflow-hidden">`);
  YearlyAnalysis($$renderer);
  $$renderer.push(`<!----></div> <div class="flex-1 min-h-0 overflow-hidden">`);
