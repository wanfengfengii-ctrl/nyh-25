...
export {
  internal_set as $,
  HYDRATION_START_ELSE as A,
  get_next_sibling as B,
  COMMENT_NODE as C,
  effect_tracking as D,
  get as E,
  render_effect as F,
  source as G,
  ...
  move_effect as S,
  defer_effect as T,
  set_active_effect as U,
  set_active_reaction as V,
  set_component_context as W,
  Batch as X,
  handle_error as Y,
  active_reaction as Z,
  component_context as _,
  sanitize_props as a,
  destroy_effect as a0,
  invoke_error_boundary as a1,
  svelte_boundary_reset_onerror as a2,
  HYDRATION_START_FAILED as a3,
  svelte_boundary_reset_noop as a4,
  EFFECT_TRANSPARENT as a5,
  EFFECT_PRESERVED as a6,
  define_property as a7,
  init_operations as a8,
  get_first_child as a9,
  hydration_failed as aa,
  clear_text_content as ab,
  component_root as ac,
  array_from as ad,
  is_passive_event as ae,
  push$1 as af,
  pop$1 as ag,
  set as ah,
  LEGACY_PROPS as ai,
